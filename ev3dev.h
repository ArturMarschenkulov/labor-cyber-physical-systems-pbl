 ...
 *
 * Modification:
 *  Add new button management for ev3dev Release 02.00.00 (ev3dev-jessie-2014-07-12) -
...
public:
    ...
    //   position is reached, the motor will stop using the action specified by
    //   `stop_action`.
...
//~autogen
    ...
    static void
    set_color(const std::vector<led*>& group, const std::vector<float>& color);
